...
exports.updateCourseValidationSchema = exports.createCourseValidationSchema = exports.levelEnum = exports.SemesterEnum = void 0;
const zod_1 = require("zod");
const level = [100, 200, 300, 400];
exports.SemesterEnum = zod_1.z.enum(['first', 'second', 'third'], {
...
const CourseCategoryEnum = zod_1.z.enum(['core', 'elective'], {
...
exports.createCourseValidationSchema = zod_1.z.object({
    ...
    semester: exports.SemesterEnum,
    category: CourseCategoryEnum,
});
exports.updateCourseValidationSchema = exports.createCourseValidationSchema.partial();
//# sourceMappingURL=course.validationSchema.js.map